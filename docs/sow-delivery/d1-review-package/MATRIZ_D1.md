...
## Procedencia de esta copia de revisión

Recuperación y consolidación documental del 2026-09-07. Copia de ../DELIVERABLE_1_ACCEPTANCE.md, con enlaces ajustados. Sustituye para esta entrega la propuesta preliminar en recuperados/: el proyecto sí dispone de logs, IDs y decisiones de alcance. No incorpora nuevas ejecuciones ni aceptación. Consultar README.md para la procedencia de los archivos y certificado-demo.html para el anexo ficticio.
